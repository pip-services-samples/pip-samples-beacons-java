package step6.org.test.services;
...
import step6.org.src.interfaces.data.version1.BeaconV1;
import step6.org.src.logic.BeaconsController;
import step6.org.src.persistence.BeaconsMemoryPersistence;
import step6.org.src.services.BeaconsHttpServiceV1;
import step6.org.test.interfaces.data.version1.TestModel;
...
public class BeaconsHttpServiceV1Test {
    ...
    private <T> T invoke(String route, T entity) throws JsonMappingException, JsonParseException, IOException {
        ...
        Response response = _client.target(request.getUri()).request(request.getMediaType())
                .post( Entity.entity("http://localhost:27017/api/v1/beacons/" + route, MediaType.APPLICATION_JSON));
